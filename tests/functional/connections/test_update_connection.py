...
@pytest.mark.parametrize(
    'connection_type_key, connection_type_value, connection_type_new_value, error_message',
    [pytest.param('connection_ty', 'friend', 'coworker', 'Missing data for required field.',
                  id='missing connection type'),
     pytest.param('connection_type', 'friend', 'worker', 'Invalid enum member',
                  id='Invalid connection type worker'),
     pytest.param('connection_type', 'brother', 'sis', 'Invalid enum member',
                  id='Invalid connection type worker')]
)
